...
PASSIVE_LISTEN_TIMEOUT_SECONDS = _env_float("NOVA_PASSIVE_LISTEN_TIMEOUT_SECONDS", 3.0)
COMMAND_LISTEN_TIMEOUT_SECONDS = _env_float("NOVA_COMMAND_LISTEN_TIMEOUT_SECONDS", 4.0)
GREETING_COMMANDS = (
    "hello",
    "good morning",
    "good afternoon",
...
WHISPER_WAKE_RECORD_SECONDS = _env_float("NOVA_WHISPER_WAKE_RECORD_SECONDS", 3.0)
...
WHISPER_CPP_PASSIVE_MODE_SECONDS = _env_float("NOVA_WHISPER_CPP_PASSIVE_MODE_SECONDS", 3.0)
WHISPER_CPP_COMMAND_MODE_SECONDS = _env_float("NOVA_WHISPER_CPP_COMMAND_MODE_SECONDS", 4.0)
